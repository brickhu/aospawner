...
var _f2, _c, _m, _g, _F, _n, _x, _o, _r, _t2, _u, _p, _s, _i, _y, _a3, __, _w, _h, _S, _b2, _l, _R, R_fn, _T, _A, _L, _d, _U, U_fn, _E, _C, _z, _v, v_fn, _O, O_fn, _P, P_fn, _a4, _I, I_fn, _j, j_fn, _e, e_fn, _D, D_fn, _W, W_fn, _b;
var lt = (_b = class {
  constructor(t) {
    ...
    if (__privateSet(this, _f2, e), __privateSet(this, _c, m), this.maxEntrySize = L || __privateGet(this, _c), this.sizeCalculation = x2, this.sizeCalculation) {
      if (!__privateGet(this, _c) && !this.maxEntrySize)
    ...
    if (this.allowStale = !!s, this.noDeleteOnStaleGet = !!w2, this.updateAgeOnGet = !!a, this.updateAgeOnHas = !!f, this.ttlResolution = j(n) || n === 0 ? n : 1, this.ttlAutopurge = !!i, this.ttl = o || 0, this.ttl) {
      ...
      __privateMethod(this, _R, R_fn).call(this);
    }
    if (__privateGet(this, _f2) === 0 && this.ttl === 0 && __privateGet(this, _c) === 0)
      throw new TypeError("At least one of max, maxSize, or ttl is required");
    if (!this.ttlAutopurge && !__privateGet(this, _f2) && !__privateGet(this, _c)) {
      let W = "LRU_CACHE_UNBOUNDED";
      sr(W) && (ae.add(W), se("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", W, _b));
    }
  }
  static unsafeExposeInternals(t) {
    return { starts: __privateGet(t, _w), ttls: __privateGet(t, _h), sizes: __privateGet(t, __), keyMap: __privateGet(t, _o), keyList: __privateGet(t, _r), valList: __privateGet(t, _t2), next: __privateGet(t, _u), prev: __privateGet(t, _p), get head() {
      ...
      var _a5;
      return __privateMethod(_a5 = t, _e, e_fn).call(_a5, e);
    }, backgroundFetch: (e, o, n, i) => {
      var _a5;
      return __privateMethod(_a5 = t, _j, j_fn).call(_a5, e, o, n, i);
    }, moveToTail: (e) => {
      var _a5;
      return __privateMethod(_a5 = t, _W, W_fn).call(_a5, e);
    }, indexes: (e) => {
      var _a5;
      return __privateMethod(_a5 = t, _v, v_fn).call(_a5, e);
    }, rindexes: (e) => {
      var _a5;
      return __privateMethod(_a5 = t, _O, O_fn).call(_a5, e);
    }, isStale: (e) => {
      var _a5;
  ...
  *entries() {
    for (let t of __privateMethod(this, _v, v_fn).call(this))
      __privateGet(this, _t2)[t] !== void 0 && __privateGet(this, _r)[t] !== void 0 && !__privateMethod(this, _e, e_fn).call(this, __privateGet(this, _t2)[t]) && (yield [__privateGet(this, _r)[t], __privateGet(this, _t2)[t]]);
  }
  *rentries() {
    for (let t of __privateMethod(this, _O, O_fn).call(this))
      __privateGet(this, _t2)[t] !== void 0 && __privateGet(this, _r)[t] !== void 0 && !__privateMethod(this, _e, e_fn).call(this, __privateGet(this, _t2)[t]) && (yield [__privateGet(this, _r)[t], __privateGet(this, _t2)[t]]);
  }
  *keys() {
    for (let t of __privateMethod(this, _v, v_fn).call(this)) {
      let e = __privateGet(this, _r)[t];
      e !== void 0 && !__privateMethod(this, _e, e_fn).call(this, __privateGet(this, _t2)[t]) && (yield e);
    }
  }
  *rkeys() {
    for (let t of __privateMethod(this, _O, O_fn).call(this)) {
  ...
  *values() {
    for (let t of __privateMethod(this, _v, v_fn).call(this))
      __privateGet(this, _t2)[t] !== void 0 && !__privateMethod(this, _e, e_fn).call(this, __privateGet(this, _t2)[t]) && (yield __privateGet(this, _t2)[t]);
  }
  *rvalues() {
    for (let t of __privateMethod(this, _O, O_fn).call(this))
      __privateGet(this, _t2)[t] !== void 0 && !__privateMethod(this, _e, e_fn).call(this, __privateGet(this, _t2)[t]) && (yield __privateGet(this, _t2)[t]);
  ...
  find(t, e = {}) {
    for (let o of __privateMethod(this, _v, v_fn).call(this)) {
      let n = __privateGet(this, _t2)[o], i = __privateMethod(this, _e, e_fn).call(this, n) ? n.__staleWhileFetching : n;
  ...
  rforEach(t, e = this) {
    for (let o of __privateMethod(this, _O, O_fn).call(this)) {
      let n = __privateGet(this, _t2)[o], i = __privateMethod(this, _e, e_fn).call(this, n) ? n.__staleWhileFetching : n;
      i !== void 0 && t.call(e, i, __privateGet(this, _r)[o], this);
    }
  }
  purgeStale() {
    let t = false;
    for (let e of __privateMethod(this, _O, O_fn).call(this, { allowStale: true }))
  ...
  info(t) {
    ...
    if (e === void 0)
      return;
    let o = __privateGet(this, _t2)[e], n = __privateMethod(this, _e, e_fn).call(this, o) ? o.__staleWhileFetching : o;
    if (n === void 0)
      return;
    let i = { value: n };
  ...
  dump() {
    ...
    for (let e of __privateMethod(this, _v, v_fn).call(this, { allowStale: true })) {
      let o = __privateGet(this, _r)[e], n = __privateGet(this, _t2)[e], i = __privateMethod(this, _e, e_fn).call(this, n) ? n.__staleWhileFetching : n;
  ...
  set(t, e, o = {}) {
    ...
    if (d === void 0)
      d = __privateGet(this, _n) === 0 ? __privateGet(this, _i) : __privateGet(this, _y).length !== 0 ? __privateGet(this, _y).pop() : __privateGet(this, _n) === __privateGet(this, _f2) ? __privateMethod(this, _I, I_fn).call(this, false) : __privateGet(this, _n), __privateGet(this, _r)[d] = t, __privateGet(this, _t2)[d] = e, __privateGet(this, _o).set(t, d), __privateGet(this, _u)[__privateGet(this, _i)] = d, __privateGet(this, _p)[d] = __privateGet(this, _i), __privateSet(this, _i, d), __privateWrapper(this, _n)._++, __privateGet(this, _C).call(this, d, _2, s), s && (s.set = "add"), l = false;
    else {
      __privateMethod(this, _W, W_fn).call(this, d);
      let g = __privateGet(this, _t2)[d];
      if (e !== g) {
        if (__privateGet(this, _b2) && __privateMethod(this, _e, e_fn).call(this, g)) {
          g.__abortController.abort(new Error("replaced"));
          let { __staleWhileFetching: m } = g;
          m !== void 0 && !a && (__privateGet(this, _S) && ((_a5 = __privateGet(this, _m)) == null ? void 0 : _a5.call(this, m, t, "set")), __privateGet(this, _l) && ((_b3 = __privateGet(this, _a3)) == null ? void 0 : _b3.push([m, t, "set"])));
        } else
          a || (__privateGet(this, _S) && ((_c2 = __privateGet(this, _m)) == null ? void 0 : _c2.call(this, g, t, "set")), __privateGet(this, _l) && ((_d2 = __privateGet(this, _a3)) == null ? void 0 : _d2.push([g, t, "set"])));
        if (__privateGet(this, _E).call(this, d), __privateGet(this, _C).call(this, d, _2, s), __privateGet(this, _t2)[d] = e, s) {
          s.set = "replace";
          let m = g && __privateMethod(this, _e, e_fn).call(this, g) ? g.__staleWhileFetching : g;
          m !== void 0 && (s.oldValue = m);
        }
      } else
        s && (s.set = "update");
    }
    if (n !== 0 && !__privateGet(this, _h) && __privateMethod(this, _R, R_fn).call(this), __privateGet(this, _h) && (l || __privateGet(this, _L).call(this, d, n, i), s && __privateGet(this, _A).call(this, s, d)), !a && __privateGet(this, _l) && __privateGet(this, _a3)) {
      let g = __privateGet(this, _a3), m;
      for (; m = g == null ? void 0 : g.shift(); )
        (_e2 = __privateGet(this, _g)) == null ? void 0 : _e2.call(this, ...m);
    }
    return this;
  }
  pop() {
    ...
    try {
      for (; __privateGet(this, _n); ) {
        ...
        if (__privateMethod(this, _I, I_fn).call(this, true), __privateMethod(this, _e, e_fn).call(this, t)) {
      ...
      if (__privateGet(this, _l) && __privateGet(this, _a3)) {
        let t = __privateGet(this, _a3), e;
  ...
  has(t, e = {}) {
    ...
    if (i !== void 0) {
      ...
      if (__privateMethod(this, _e, e_fn).call(this, a) && a.__staleWhileFetching === void 0)
        return false;
  ...
  peek(t, e = {}) {
    ...
    return __privateMethod(this, _e, e_fn).call(this, i) ? i.__staleWhileFetching : i;
  }
  async fetch(t, e = {}) {
    ...
    if (y === void 0) {
      p && (p.fetch = "miss");
      let v2 = __privateMethod(this, _j, j_fn).call(this, t, y, A, x2);
      return v2.__returned = v2;
    } else {
      let v2 = __privateGet(this, _t2)[y];
      if (__privateMethod(this, _e, e_fn).call(this, v2)) {
      ...
      if (!S && !z3)
        return p && (p.fetch = "hit"), __privateMethod(this, _W, W_fn).call(this, y), n && __privateGet(this, _T).call(this, y), p && __privateGet(this, _A).call(this, p, y), v2;
      let W = __privateMethod(this, _j, j_fn).call(this, t, y, A, x2), Lt2 = W.__staleWhileFetching !== void 0 && o;
  ...
  get(t, e = {}) {
    ...
    if (f !== void 0) {
      let s = __privateGet(this, _t2)[f], l = __privateMethod(this, _e, e_fn).call(this, s);
      return a && __privateGet(this, _A).call(this, a, f), __privateGet(this, _d).call(this, f) ? (a && (a.get = "stale"), l ? (a && o && s.__staleWhileFetching !== void 0 && (a.returnedStale = true), o ? s.__staleWhileFetching : void 0) : (i || this.delete(t), a && o && (a.returnedStale = true), o ? s : void 0)) : (a && (a.get = "hit"), l ? s.__staleWhileFetching : (__privateMethod(this, _W, W_fn).call(this, f), n && __privateGet(this, _T).call(this, f), s));
    } else
      a && (a.get = "miss");
  }
  delete(t) {
    ...
    if (__privateGet(this, _n) !== 0) {
      ...
      if (o !== void 0)
        if (e = true, __privateGet(this, _n) === 1)
          ...
          if (__privateMethod(this, _e, e_fn).call(this, n) ? n.__abortController.abort(new Error("deleted")) : (__privateGet(this, _S) || __privateGet(this, _l)) && (__privateGet(this, _S) && ((_a5 = __privateGet(this, _m)) == null ? void 0 : _a5.call(this, n, t, "delete")), __privateGet(this, _l) && ((_b3 = __privateGet(this, _a3)) == null ? void 0 : _b3.push([n, t, "delete"]))), __privateGet(this, _o).delete(t), __privateGet(this, _r)[o] = void 0, __privateGet(this, _t2)[o] = void 0, o === __privateGet(this, _i))
    ...
    if (__privateGet(this, _l) && ((_c2 = __privateGet(this, _a3)) == null ? void 0 : _c2.length)) {
      let o = __privateGet(this, _a3), n;
  ...
  clear() {
    var _a5, _b3, _c2;
    for (let t of __privateMethod(this, _O, O_fn).call(this, { allowStale: true })) {
      let e = __privateGet(this, _t2)[t];
      if (__privateMethod(this, _e, e_fn).call(this, e))
        e.__abortController.abort(new Error("deleted"));
      else {
        let o = __privateGet(this, _r)[t];
        __privateGet(this, _S) && ((_a5 = __privateGet(this, _m)) == null ? void 0 : _a5.call(this, e, o, "delete")), __privateGet(this, _l) && ((_b3 = __privateGet(this, _a3)) == null ? void 0 : _b3.push([e, o, "delete"]));
      }
    }
    if (__privateGet(this, _o).clear(), __privateGet(this, _t2).fill(void 0), __privateGet(this, _r).fill(void 0), __privateGet(this, _h) && __privateGet(this, _w) && (__privateGet(this, _h).fill(0), __privateGet(this, _w).fill(0)), __privateGet(this, __) && __privateGet(this, __).fill(0), __privateSet(this, _s, 0), __privateSet(this, _i, 0), __privateGet(this, _y).length = 0, __privateSet(this, _x, 0), __privateSet(this, _n, 0), __privateGet(this, _l) && __privateGet(this, _a3)) {
      let t = __privateGet(this, _a3), e;
      for (; e = t == null ? void 0 : t.shift(); )
        (_c2 = __privateGet(this, _g)) == null ? void 0 : _c2.call(this, ...e);
    }
  }
}, _a4 = Symbol.toStringTag, _f2 = new WeakMap(), _c = new WeakMap(), _m = new WeakMap(), _g = new WeakMap(), _F = new WeakMap(), _n = new WeakMap(), _x = new WeakMap(), _o = new WeakMap(), _r = new WeakMap(), _t2 = new WeakMap(), _u = new WeakMap(), _p = new WeakMap(), _s = new WeakMap(), _i = new WeakMap(), _y = new WeakMap(), _a3 = new WeakMap(), __ = new WeakMap(), _w = new WeakMap(), _h = new WeakMap(), _S = new WeakMap(), _b2 = new WeakMap(), _l = new WeakMap(), _R = new WeakSet(), R_fn = function() {
...
}, _T = new WeakMap(), _A = new WeakMap(), _L = new WeakMap(), _d = new WeakMap(), _U = new WeakSet(), U_fn = function() {
  ...
  __privateSet(this, _x, 0), __privateSet(this, __, t), __privateSet(this, _E, (e) => {
    ...
    if (__privateMethod(this, _e, e_fn).call(this, o))
      return 0;
    if (!j(n))
      if (i) {
    ...
    if (t[e] = o, __privateGet(this, _c)) {
      let i = __privateGet(this, _c) - t[e];
      for (; __privateGet(this, _x) > i; )
        __privateMethod(this, _I, I_fn).call(this, true);
    }
    __privateSet(this, _x, __privateGet(this, _x) + t[e]), n && (n.entrySize = o, n.totalCalculatedSize = __privateGet(this, _x));
  });
}, _E = new WeakMap(), _C = new WeakMap(), _z = new WeakMap(), _v = new WeakSet(), v_fn = function* ({ allowStale: t = this.allowStale } = {}) {
  if (__privateGet(this, _n))
    for (let e = __privateGet(this, _i); !(!__privateMethod(this, _P, P_fn).call(this, e) || ((t || !__privateGet(this, _d).call(this, e)) && (yield e), e === __privateGet(this, _s))); )
      e = __privateGet(this, _p)[e];
}, _O = new WeakSet(), O_fn = function* ({ allowStale: t = this.allowStale } = {}) {
  if (__privateGet(this, _n))
    for (let e = __privateGet(this, _s); !(!__privateMethod(this, _P, P_fn).call(this, e) || ((t || !__privateGet(this, _d).call(this, e)) && (yield e), e === __privateGet(this, _i))); )
      e = __privateGet(this, _u)[e];
}, _P = new WeakSet(), P_fn = function(t) {
  return t !== void 0 && __privateGet(this, _o).get(__privateGet(this, _r)[t]) === t;
}, _I = new WeakSet(), I_fn = function(t) {
  var _a5, _b3;
  let e = __privateGet(this, _s), o = __privateGet(this, _r)[e], n = __privateGet(this, _t2)[e];
  return __privateGet(this, _b2) && __privateMethod(this, _e, e_fn).call(this, n) ? n.__abortController.abort(new Error("evicted")) : (__privateGet(this, _S) || __privateGet(this, _l)) && (__privateGet(this, _S) && ((_a5 = __privateGet(this, _m)) == null ? void 0 : _a5.call(this, n, o, "evict")), __privateGet(this, _l) && ((_b3 = __privateGet(this, _a3)) == null ? void 0 : _b3.push([n, o, "evict"]))), __privateGet(this, _E).call(this, e), t && (__privateGet(this, _r)[e] = void 0, __privateGet(this, _t2)[e] = void 0, __privateGet(this, _y).push(e)), __privateGet(this, _n) === 1 ? (__privateSet(this, _s, __privateSet(this, _i, 0)), __privateGet(this, _y).length = 0) : __privateSet(this, _s, __privateGet(this, _u)[e]), __privateGet(this, _o).delete(o), __privateWrapper(this, _n)._--, e;
}, _j = new WeakSet(), j_fn = function(t, e, o, n) {
  let i = e === void 0 ? void 0 : __privateGet(this, _t2)[e];
  if (__privateMethod(this, _e, e_fn).call(this, i))
    return i;
...
}, _e = new WeakSet(), e_fn = function(t) {
  if (!__privateGet(this, _b2))
    return false;
  let e = t;
  return !!e && e instanceof Promise && e.hasOwnProperty("__staleWhileFetching") && e.__abortController instanceof ut;
}, _D = new WeakSet(), D_fn = function(t, e) {
  __privateGet(this, _p)[e] = t, __privateGet(this, _u)[t] = e;
}, _W = new WeakSet(), W_fn = function(t) {
  t !== __privateGet(this, _i) && (t === __privateGet(this, _s) ? __privateSet(this, _s, __privateGet(this, _u)[t]) : __privateMethod(this, _D, D_fn).call(this, __privateGet(this, _p)[t], __privateGet(this, _u)[t]), __privateMethod(this, _D, D_fn).call(this, __privateGet(this, _i), t), __privateSet(this, _i, t));
}, _b);
var R;
var Y;
function ue({ size: r3 }) {
  ...
  return function f3(a, b2, c2) {
    switch (arguments.length) {
      case 0:
        return f3;
      case 1:
        return _isPlaceholder(a) ? f3 : _curry2(function(_b3, _c2) {
          return fn(a, _b3, _c2);
        });
      case 2:
        return _isPlaceholder(a) && _isPlaceholder(b2) ? f3 : _isPlaceholder(a) ? _curry2(function(_a5, _c2) {
          return fn(_a5, b2, _c2);
        }) : _isPlaceholder(b2) ? _curry2(function(_b3, _c2) {
          return fn(a, _b3, _c2);
        }) : _curry1(function(_c2) {
          return fn(a, b2, _c2);
        });
      default:
        ...
        }) : _isPlaceholder(a) && _isPlaceholder(c2) ? _curry2(function(_a5, _c2) {
          return fn(_a5, b2, _c2);
        }) : _isPlaceholder(b2) && _isPlaceholder(c2) ? _curry2(function(_b3, _c2) {
          return fn(a, _b3, _c2);
        }) : _isPlaceholder(a) ? _curry1(function(_a5) {
          return fn(_a5, b2, c2);
        }) : _isPlaceholder(b2) ? _curry1(function(_b3) {
          return fn(a, _b3, c2);
        }) : _isPlaceholder(c2) ? _curry1(function(_c2) {
          return fn(a, b2, _c2);
        }) : fn(a, b2, c2);
    }
  };
...
@permaweb/aoconnect/dist/browser.js:
  ...
  *)
*/
//# sourceMappingURL=@permaweb_aoconnect_browser.js.map
