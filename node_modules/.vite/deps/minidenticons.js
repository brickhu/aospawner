...
var _a, _b, _memoized, _isConnected, _setContent, setContent_fn, _c;
var minidenticonSvg = (
  ...
  ((_a = globalThis.customElements) == null ? void 0 : _a.get("minidenticon-svg")) ? null : (_c = globalThis.customElements) == null ? void 0 : _c.define(
    ...
    }, _memoized = new WeakMap(), _isConnected = new WeakMap(), _setContent = new WeakSet(), setContent_fn = function() {
      var _a2;
